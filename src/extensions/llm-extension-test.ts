...
//             let systemMessage: string = `You are a minecraft player. 
//     Just play the game and help other players. 

//     ANSWER SHORTLY AND CONCISELY IN RUSSIAN LANGUAGE. 
    
//     Для выполнения задач используйте TODO LIST. Разбивай задачи на подзадачи и выполняй их по очереди.
//     Изменяй TODO LIST через функцию set_todo_list.

//     Your todo list: ${this.bot.todoList || "Empty"}
// `;

//             temp_messages.splice(-4, 0, {
//                 role: "user",
